...
class ProductDislikeService
{
    ...
    public function showSeveralChoices()
    {
        if ($this->mesa == '1' and $this->varske == '1' and $this->zuvis == '1' and $this->grudai == '1') {
            ...
            $multiChoice = 'Jūs pasirinkote, jog nemėgstate mėsos, varškės bei avižinės 
            košės. Esant prieštaravimui tarp jūsų nemėgstamų produktų alternatyvų,
            siūlome pasirinkti kiaušinius.';
        } elseif ($this->mesa == '1' and $this->varske == '1' and $this->grudai == '1') {
            $multiChoice = 'Jūs pasirinkote, jog nemėgstate mėsos, varškės bei avižinės 
            košės. Esant prieštaravimui tarp jūsų nemėgstamų produktų alternatyvų, siūlome
            pasirinkite varškę su mėsa pakeisti į tuną arba lašišą, o avižas - į makaronus.';
            ...
            Esant prieštaravimui tarp jūsų nemėgtamų produktų alternatyvų, vietoje mėsos ir
            žuvies siūlome pasirinkti varškę/jogurtą, o viešoje avižų - makaronus.';
            ...
            Esant prieštara vimui tarp jūsų nemėgstamų produktų, vietoje žuvies ir varškes
            ...
            $multiChoice = 'Jūs pasirinkote, jog nemėgstate varškes ir avižinės košės. Esant prieštarav
            imui tarp jūsų nemėgstamų produktų alternatyvų, vietoje varškės rinkitės mėsą - jautieną 
            ar vištieną, o vietoje avižinės košės - makaronus/ryžius/grikius.';
        } elseif ($this->mesa == '1' and $this->grudai == '1') {
            $multiChoice = 'Jūs pasirinkote, jog nemėgstate mėsos bei avižinės košės. Esant prieštarav
            imui tarp jūsų nemėgstamų produktų alternatyvų, vietoje mėsos rinkitės varške arba 
            tuną/lašišą, o vietoje avižinės košės - makaronus/ryžius/grikius.';
